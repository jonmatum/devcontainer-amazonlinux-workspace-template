...
# Check if OpenTofu is already installed and the correct version
...
echo "Downloading OpenTofu v$TOFU_VERSION for architecture $TOFU_ARCH..."
mkdir -p "$TMP_DIR"
curl -sL "https://github.com/opentofu/opentofu/releases/download/v${TOFU_VERSION}/tofu_${TOFU_VERSION}_linux_${TOFU_ARCH}.zip" -o "$TMP_DIR/tofu.zip"
